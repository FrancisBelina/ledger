...
- Use the project-local `.llm-review/` mailbox for Codex/Claude review cycles.
- Keep Codex and Claude from editing the same working tree concurrently.
- If implementation begins later and parallel work is needed, use separate git worktrees.

## Priorities

1. Five minutes or less of monthly maintenance.
